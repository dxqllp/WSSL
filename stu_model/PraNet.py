...
class aggregation(nn.Module):
    ...
    def __init__(self, channel):
        ...
        self.upsample = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True)  #scale_factor=2放大系数
...
class PraNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = -1*(torch.sigmoid(crop_4)) + 1 # 经过 sigmoid和反向过程
        ...
        return torch.sigmoid(lateral_map_5), torch.sigmoid_(lateral_map_4), torch.sigmoid_(lateral_map_3), torch.sigmoid(lateral_map_2)
...
if __name__ == '__main__':
    ...
    out1,out2,out3,out4,x0 = ras(input_tensor)
    print(x0[0][0].shape)
