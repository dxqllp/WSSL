...
import torch
from util.loss import DeepSupervisionLoss
from util.no_loss import DeepSupervisionLoss_no
...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    # cnt = 0
    for index,(samples, points, targets,fname) in enumerate(data_loader):
        ...
        losses = DeepSupervisionLoss(outputs, targets)
